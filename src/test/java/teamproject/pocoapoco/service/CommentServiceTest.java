...
class CommentServiceTest {
    ...
    private SseSender sseSender = Mockito.mock(SseSender.class);
    ...
    void setUp() {
        ...
        commentService = new CommentService(commentRepository, userRepository, crewRepository, alarmRepository, sseSender);
